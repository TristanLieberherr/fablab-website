                            ...
                            <td
                              ...
                              <div style="color: #303030; line-height: 120%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 120%; text-align: center;"><span
                                    style="font-size: 20px; line-height: 24px;">Vous avez de nouvelles notifications
                                    concernant vos travaux !</span></p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              align="left">
                              <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%; text-align: left;">{{ $job->new_files_count }}</p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
                        ...
                        <tbody>
                          <tr>
                            <td
                              ...
                              align="left">
                              <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 140%; text-align: left;">{{ $job->new_messages_count }}</p>
                              </div>
                            </td>
                          </tr>
                        </tbody>
                          ...
                          <tr>
                            <td
                              ...
                              <div
                                ...
                                <p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
                                <p style="font-size: 14px; line-height: 140%;"><span
                                    style="font-size: 12px; line-height: 16.8px;">Copyright &copy; 2017 Your Company.
